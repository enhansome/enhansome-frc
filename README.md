...
* [State Space Guide](https://github.com/calcmogul/state-space-guide) ⭐ 370 | 🐛 0 | 🌐 TeX | 📅 2026-08-06 - A practical guide to state-space control: graduate-level control theory for high schoolers.
* [GradleRIO](https://github.com/wpilibsuite/GradleRIO) ⭐ 282 | 🐛 50 | 🌐 Java | 📅 2026-08-03 - A powerful Gradle Plugin that allows teams competing in the FIRST robotics competition to produce and build their code.
...
* [WPILib](https://github.com/wpilibsuite/allwpilib) ⭐ 1,290 | 🐛 608 | 🌐 C++ | 📅 2026-08-13 - The official WPILib repository, containing code for the Java and C++ libraries.
...
* [WPILib (Java/C++)](https://github.com/wpilibsuite/allwpilib) ⭐ 1,290 | 🐛 608 | 🌐 C++ | 📅 2026-08-13 - The official WPILib repository, containing code for the Java and C++ libraries.
