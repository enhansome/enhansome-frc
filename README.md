...
* [State Space Guide](https://github.com/calcmogul/state-space-guide) ⭐ 374 | 🐛 0 | 🌐 TeX | 📅 2026-09-10 - A practical guide to state-space control: graduate-level control theory for high schoolers.
* [GradleRIO](https://github.com/wpilibsuite/GradleRIO) ⭐ 281 | 🐛 45 | 🌐 Java | 📅 2026-09-08 - A powerful Gradle Plugin that allows teams competing in the FIRST robotics competition to produce and build their code.
...
* [2729 Storm Robotics Vision](https://github.com/2729StormRobotics/StormCV2017) ⚠️ Archived - An example of using OpenCV and GRIP to create a vision system.
...
* [Robot Scouter](https://github.com/SUPERCILEX/Robot-Scouter) ⭐ 110 | 🐛 47 | 🌐 Kotlin | 📅 2022-12-12 - Gorgeous and powerful Android scouting app.
* [VictiScout](https://github.com/FRCScout/FRCScout) ⭐ 23 | 🐛 30 | 🌐 JavaScript | 📅 2024-01-31 - Light Electron scouting app by Team 1418.

## Driving

* [QDriverStation](https://github.com/FRC-Utilities/QDriverStation) ⭐ 200 | 🐛 11 | 🌐 QML | 📅 2025-11-11 - Popular open-source Driver Station clone for all Desktop platforms. Though not permitted in competition, essential for teams wishing to drive on another platform or up their open source cred.
* [FRCDashboard](https://github.com/FRCDashboard/FRCDashboard) ⭐ 140 | 🐛 4 | 🌐 JavaScript | 📅 2022-08-19 - Powerful and flexible boilerplate for creating complex driving dashboards with web technologies.
...
* [WPILib](https://github.com/wpilibsuite/allwpilib) ⭐ 1,303 | 🐛 592 | 🌐 C++ | 📅 2026-09-18 - The official WPILib repository, containing code for the Java and C++ libraries.
...
* [WPILib (Java/C++)](https://github.com/wpilibsuite/allwpilib) ⭐ 1,303 | 🐛 592 | 🌐 C++ | 📅 2026-09-18 - The official WPILib repository, containing code for the Java and C++ libraries.
...
* [WPILib (C#)](https://github.com/robotdotnet/WPILib) ⭐ 28 | 🐛 10 | 🌐 C# | 📅 2026-06-02 - Unofficial WPILib port for writing robot code in C#.
* [FRC-Extension (Visual Studio)](https://github.com/robotdotnet/FRC-Extension) ⭐ 5 | 🐛 13 | 🌐 C# | 📅 2018-01-12 - Visual Studio extension to make writing C# robots a breeze.
* [NetworkTables (C#)](https://github.com/robotdotnet/NetworkTables) ⭐ 3 | 🐛 11 | 🌐 C# | 📅 2020-11-11 - Unofficial NetworkTables port for C#.

### Python

* [RobotPy-WPILib](https://github.com/robotpy/robotpy-wpilib) ⚠️ Archived - Unofficial WPILib port allowing you to write robot code in Python.
* [pynetworktables](https://github.com/robotpy/pynetworktables) ⭐ 62 | 🐛 11 | 🌐 Python | 📅 2025-09-26 - Port to allow access of NetworkTables in Python.
* [pyrobottraining](https://github.com/robotpy/pyrobottraining) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2015-12-30 - Fundamental tutorial for FRC robot coding in Python.
* [TBApi](https://github.com/PlasmaRobotics2403/TBApi) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2017-09-20 - A Python library for interacting with The Blue Alliance API.

### CSS

* [banners.css](https://github.com/ErikBoesen/banners.css) ⭐ 24 | 🐛 1 | 🌐 CSS | 📅 2018-08-09 - Library for creating pure CSS FRC banners. Utilitarian and pretty decoration for team websites.

### Ruby

* [tba.rb](https://github.com/frc1418/tba.rb) ⭐ 3 | 🐛 2 | 🌐 Ruby | 📅 2018-06-27 - Simple Ruby library for easy interaction with The Blue Alliance API.

### JavaScript

* [TBA Node API](https://github.com/Team2537/tba-api-node) ⚠️ Archived - A Node.js library for interacting with The Blue Alliance API.
...
* [FRC Bot](https://github.com/FRC-Bot/FRCBot-ChatBot) ⭐ 6 | 🐛 6 | 🌐 PHP | 📅 2017-04-18 - Facebook Messenger bot to get information about FRC teams, events, and matches.
