...
* [State Space Guide](https://github.com/calcmogul/state-space-guide) ⭐ 371 | 🐛 0 | 🌐 TeX | 📅 2026-08-06 - A practical guide to state-space control: graduate-level control theory for high schoolers.
* [GradleRIO](https://github.com/wpilibsuite/GradleRIO) ⭐ 282 | 🐛 49 | 🌐 Java | 📅 2026-08-15 - A powerful Gradle Plugin that allows teams competing in the FIRST robotics competition to produce and build their code.
...
* [WPILib](https://github.com/wpilibsuite/allwpilib) ⭐ 1,291 | 🐛 611 | 🌐 C++ | 📅 2026-08-15 - The official WPILib repository, containing code for the Java and C++ libraries.
...
* [WPILib (Java/C++)](https://github.com/wpilibsuite/allwpilib) ⭐ 1,291 | 🐛 611 | 🌐 C++ | 📅 2026-08-15 - The official WPILib repository, containing code for the Java and C++ libraries.
